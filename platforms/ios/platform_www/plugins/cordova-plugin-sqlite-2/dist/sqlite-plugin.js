...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.sqlitePlugin = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"lodash._baseeach":2,"lodash._baseiteratee":3}],6:[function(require,module,exports){
/**
 * lodash 4.1.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright 2012-2016 The Dojo Foundation <http://dojofoundation.org/>
...
},{"../lib/custom":10}],10:[function(require,module,exports){
'use strict';
...
},{"./websql/WebSQLDatabase":11,"argsarray":1,"immediate":14,"noop-fn":7}],11:[function(require,module,exports){
'use strict';
...
},{"./WebSQLTransaction":13,"immediate":14,"noop-fn":7,"tiny-queue":20}],12:[function(require,module,exports){
'use strict';
...
},{"./WebSQLResultSet":12,"immediate":14,"noop-fn":7,"tiny-queue":20}],14:[function(require,module,exports){
'use strict';
var types = [
  require('./nextTick'),
  require('./mutation.js'),
...
},{"./messageChannel":15,"./mutation.js":16,"./nextTick":17,"./stateChange":18,"./timeout":19}],15:[function(require,module,exports){
(function (global){
'use strict';
...
var customOpenDatabase = _interopDefault(require('websql/custom'));
...
var index_js = new SQLitePlugin();

module.exports = index_js;
},{"lodash.map":5,"lodash.zipObject":6,"websql/custom":9}]},{},[21])(21)
});
});
