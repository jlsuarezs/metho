        ...
        switch (name) {
            case "projects":
                window.plugins.socialsharing.shareViaEmail(
                    ...
                    "Problème dans l'onglet Projets", ['methoappeei@gmail.com@gmail.com'], // TO: must be null or an array
            ...
            case "refs":
                window.plugins.socialsharing.shareViaEmail(
                    ...
                    "Problème dans l'onglet Référence", ['methoappeei@gmail.com'], // TO: must be null or an array
                    [], // CC: must be null or an array
                    null, // BCC: must be null or an array
                    [], // FILES: can be null, a string, or an array
                    function() { // Success
            ...
            case "settings":
                window.plugins.socialsharing.shareViaEmail(
                    ...
                    "Problème concernant les paramètres", ['methoappeei@gmail.com'], // TO: must be null or an array
                    [], // CC: must be null or an array
                    null, // BCC: must be null or an array
                    [], // FILES: can be null, a string, or an array
                    function() { // Success
            ...
            case "comment":
                window.plugins.socialsharing.shareViaEmail(
                    ...
                    "Commentaire", ['methoappeei@gmail.com'], // TO: must be null or an array
                    [], // CC: must be null or an array
                    null, // BCC: must be null or an array
                    [], // FILES: can be null, a string, or an array
                    function() { // Success
            ...
            case "feature":
                window.plugins.socialsharing.shareViaEmail(
                    ...
                    "Suggestion de fonctionalité", ['methoappeei@gmail.com'], // TO: must be null or an array
                    [], // CC: must be null or an array
                    null, // BCC: must be null or an array
                    [], // FILES: can be null, a string, or an array
                    function() { // Success
